        ...
        <div class="prod-card">
            ...
            <form action="{{ route('products.update', $product->product_id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="prod-form-group">
                    ...
                    <input type="text" name="product_name" id="product_name" class="prod-form-control" placeholder="Enter product name" value="{{ old('product_name', $product->product_name) }}" required>
                </div>
                ...
                <div class="prod-form-row">
                    <div class="prod-form-group">
                        ...
                        <input type="number" step="0.01" min="0" name="price" id="price" class="prod-form-control" placeholder="0.00" value="{{ old('price', $product->price) }}">
                    </div>

                    <div class="prod-form-group">
                        <label for="qty" class="prod-form-label">Quantity</label>
                        <input type="number" min="0" name="qty" id="qty" class="prod-form-control" placeholder="0" value="{{ old('qty', $product->qty) }}">
                    </div>
                </div>
                ...
                <div class="prod-form-row">
                    <div class="prod-form-group">
                        ...
                        <input type="text" name="product_type" id="product_type" class="prod-form-control" placeholder="e.g. Electronics" value="{{ old('product_type', $product->product_type) }}">
                    </div>
                ...
                <div class="prod-form-group">
                    ...
                    <textarea name="description" id="description" class="prod-form-control" rows="4" placeholder="Enter description">{{ old('description', $product->description) }}</textarea>
                </div>
