    ...
    <div class="col-lg-4 d-flex flex-column justify-content-between">
        ...
        <div class="row g-2">
            ...
            <div class="col-12 mt-2">
                <button type="button" class="btn btn-success w-100 py-2" data-bs-toggle="modal" data-bs-target="#paymentModal">
                    <i class="fa-solid fa-wallet me-2"></i> Pay Now
                </button>
            
                @include('pos.component.payment')
            </div>
        </div>
